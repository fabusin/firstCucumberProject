...
public class UserManagementSteps {
	...
	@When("I enter invalid username and and valid password")
	public void i_enter_invalid_username_and_and_valid_password() {
	...
	public void i_enter_valid_username_and_invalid_password() {
		utils.actionsSendKeys(loginpage.emailField, DataReader.getProperty("username"));
		utils.actionsSendKeys(loginpage.passwordField, "hellowWorld123");
	}
